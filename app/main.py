...
from app.routers import (
    users, tasks, misalignments, users_orgchart, alignment_stats, chat, pending_questions, admin, prompts, prompt_preview, daily_sync, import_export, mcp_tools, decisions
)
...
app.include_router(mcp_tools.router)  # MCP Tools debugger
app.include_router(decisions.router)  # Pending decisions (proposals, acceptances)
